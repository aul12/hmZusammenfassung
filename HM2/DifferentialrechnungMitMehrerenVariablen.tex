...
Ist $f: A \subseteq \R^ \rightarrow B \subseteq \R^m$ total differentierbar in
...
\begin{enumerate}[label= (\alph*)]
    \item Eine Funktion $f: G \subseteq \R^n \rightarrow \R$ besitzt in $x_0 \in G$ ein
        lokales Minimum (bzw. Maximum), wenn in einer Umgebun von $U$ von $x_0$ gilt:
        \begin{equation*}
